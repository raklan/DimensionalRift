...
package net.mcreator.dimensionalrift.world;
...
import net.mcreator.dimensionalrift.item.ItemWinterDimension;
...
public class WorldWinterDimension extends ElementsDimensionalRift.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = true;
	@GameRegistry.ObjectHolder("dimensionalrift:winterdimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldWinterDimension(ElementsDimensionalRift instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemWinterDimension().setUnlocalizedName("winterdimension").setRegistryName("winterdimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension winterdimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("winterdimension", "_winterdimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemWinterDimension.block, 0,
				new ModelResourceLocation("dimensionalrift:winterdimension", "inventory"));
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.ICE.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("winterdimension_portal");
			setRegistryName("winterdimension_portal");
			setLightLevel(0.02F);
		}
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.SNOW_SHOVEL, px, py, pz, vx, vy, vz);
			}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.ICE.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.ICE.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.ICE.getDefaultState()
							.getBlock()) {
						this.height = 0;
						break;
					}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState STONE3 = Blocks.FROSTED_ICE.getDefaultState();
